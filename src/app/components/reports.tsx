    ...
    <div className="h-screen bg-[#307fec] flex justify-center items-center py-10 px-4">
      <div className="w-full h-full bg-[#ffffff] rounded-xl p-8 shadow-2xl text-white">
        <img
          ...
          alt="Logo"
          className="w-auto h-20 m-auto rounded-full"
        />
        <h1 className="text-4xl font-bold text-black text-center mb-8 mt-5">
          AVAILABLE REPORTS
        </h1>
            ...
            {availableReports.map((report:any, index:any) => (
              ...
              >
                <div className="flex justify-between items-center mb-5">
                  <div className="text-2xl font-semibold text-[#fffff] hover:text-white transition-colors duration-300">
                    {report.reportname}
                  </div>
                  <img
                    src={report.logo}
                ...
                <button className="px-4 py-2 rounded text-white bg-[#307fec] hover:bg-[#1e77d0] transition-colors duration-300">
